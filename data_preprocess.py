...
audio_path= r'.\data\clean_trainset_wav_28speakers'                                          # utterance dataset
clean_path = r'.\data\clean_testset_wav_2speakers'  # clean dataset
noisy_path = r'.\data\clean_testset_wav_2speakers'  # noisy dataset
